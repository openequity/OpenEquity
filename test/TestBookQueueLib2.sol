...
contract TestBookQueueLib2{
  ...
  function test0_insertReader3(){
    ...
    queue2.insertReader( readerAddress3,value);
	  queue2.insertReader( readerAddress2,value1);
	  queue2.insertReader( readerAddress1,value2);
    queue2.insertReader( readerAddress,value3);
